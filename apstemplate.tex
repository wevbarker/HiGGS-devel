...
\begin{subequations}
  \begin{align}
    J^{-1}\tensor{\hat{\pi}}{_{i}^{\bar{k}}}=&\ 4\tensor{\hat{\beta}}{_{I}}\tensor{n}{_{[j}}\tensor*{\delta}{_{l]}^{\bar{k}}}\tensor[^I]{\mathcal{  P}}{_i^{jl}_n^{mo}}\tensor{\mathcal{  T}}{^n_{mo}},\\
...
\begin{equation}
  \begin{gathered}
    \frac{\partial\tensor{n}{_j}}{\partial\tensor{b}{^i_\mu}}=-\tensor{n}{_i}\tensor{h}{_{\bar{j}}^\mu}, \quad \frac{\partial\tensor{h}{_j^\nu}}{\partial\tensor{b}{^i_\mu}}=-\tensor{h}{_i^\nu}\tensor{h}{_j^\nu}, \quad \frac{\partial b}{\partial\tensor{b}{^i_\nu}}=b\tensor{h}{_i^\nu},\\
    \frac{\partial J^{-1}\tensor{b}{^k_\alpha}\tensor*{\delta}{^\alpha_\nu}}{\partial \tensor{b}{^i_\mu}}=J^{-1}\tensor*{\delta}{^k_i}\tensor*{\delta}{^\mu_\alpha}\tensor*{\delta}{^\alpha_\nu}-J^{-1}\tensor{b}{^k_\alpha}\tensor*{\delta}{^\alpha_\nu}\tensor{h}{_{\bar{i}}^\mu}.
  \end{gathered}
  \label{<+label+>}
\end{equation}
Note the last identity is made more annoying by the restriction to the $3$-space (i.e. you can't just replace the contractions).
