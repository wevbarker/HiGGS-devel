...
DefIfConstraintToTheoryNesterForm[TheoryName_?StringQ]:=Module[{
	...
	VarPhiParas=DeleteCases[Evaluate[{(1-ShellParaLambB0m)VarPhiParaB0m[],(1-ShellParaLambB1p)VarPhiParaB1p[-i,-j],(1-ShellParaLambB1m)VarPhiParaB1m[-i],(1-ShellParaLambB2m)VarPhiParaB2m[-i,-j,-k],(1-ShellParaLambA0p)VarPhiParaA0p[],(1-ShellParaLambA0m)VarPhiParaA0m[],(1-ShellParaLambA1p)VarPhiParaA1p[-i,-j],(1-ShellParaLambA1m)VarPhiParaA1m[-i],(1-ShellParaLambA2p)VarPhiParaA2p[-i,-j],(1-ShellParaLambA2m)VarPhiParaA2m[-i,-j,-k]}/.(Evaluate@(Theory@$ToShellFreedoms))],0,Infinity];
	$IfConstraintsValue=$IfConstraintsValue~Join~VarPhiParas;
	VarPhiParas=({#,ImposeTheory[#,TheoryName]})&/@VarPhiParas;
	Print["** DefTheory: Found the following primary parallel if-constraints associated with geometric multiplier momenta:"];
	(Print[#[[1]]," \[Congruent] ",#[[2]]," \[TildeTilde] 0"])&/@VarPhiParas;

	VarPhiPerps=DeleteCases[Evaluate[{(1-ShellPerpLambB0p)VarPhiParaB0p[],(1-ShellPerpLambB1p)VarPhiParaB1p[-i,-j],(1-ShellPerpLambB1m)VarPhiParaB1m[-i],(1-ShellPerpLambB2p)VarPhiParaB2p[-i,-j],(1-ShellPerpLambA0p)VarPhiParaA0p[],(1-ShellPerpLambA0m)VarPhiParaA0m[],(1-ShellPerpLambA1p)VarPhiParaA1p[-i,-j],(1-ShellPerpLambA1m)VarPhiParaA1m[-i],(1-ShellPerpLambA2p)VarPhiParaA2p[-i,-j],(1-ShellPerpLambA2m)VarPhiParaA2m[-i,-j,-k]}/.(Evaluate@(Theory@$ToShellFreedoms))],0,Infinity];
...
(*
	VarPhiSings=DeleteCases[Evaluate[{(1-ShellSingLambB0p)VarPhiSingB0p[],(1-ShellSingLambB1p)VarPhiSingB1p[-i,-j],(1-ShellSingLambB1m)VarPhiSingB1m[-i],(1-ShellSingLambB2p)VarPhiSingB2p[-i,-j],(1-ShellSingLambA0p)VarPhiSingA0p[],(1-ShellSingLambA0m)VarPhiSingA0m[],(1-ShellSingLambA1p)VarPhiSingA1p[-i,-j],(1-ShellSingLambA1m)VarPhiSingA1m[-i],(1-ShellSingLambA2p)VarPhiSingA2p[-i,-j],(1-ShellSingLambA2m)VarPhiSingA2m[-i,-j,-k]}/.(Evaluate@(Theory@$ToShellFreedoms))],0,Infinity];
	$IfConstraintsValue=$IfConstraintsValue~Join~VarPhiSings;
	VarPhiSings=({#,ImposeTheory[#,TheoryName]})&/@VarPhiSings;
	Print["** DefTheory: Found the following primary parallel if-constraints associated with geometric multiplier momenta:"];
	(Print[#[[1]]," \[Congruent] ",#[[2]]," \[TildeTilde] 0"])&/@VarPhiSings;
*)
