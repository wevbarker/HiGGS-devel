...
TotalToO3[x_,OptionsPattern[]]:=Module[{Expr,PrintVariable},
	PrintVariable=PrintTemporary[" ** TotalToO3 with ToShell ",OptionValue["ToShell"]," and Order ",OptionValue["Order"],"..."];
	Expr=x;
...
PreSimplify[x_,OptionsPattern[]]:=Module[{Expr,PrintVariable},
	PrintVariable=PrintTemporary[" ** TotalToO3 with Hard ",OptionValue["Hard"]," and Order ",OptionValue["Order"],"..."];
	Expr=x;
	Expr=Global`ToOrderCanonical[Expr,OptionValue["Order"]];
...
ToNesterForm[x_,OptionsPattern[]]:=Module[{Expr,PrintVariable},
	PrintVariable=PrintTemporary[" ** ToNesterForm with Hard ",OptionValue["Hard"]," and Order ",OptionValue["Order"]," and GToFoliG ",OptionValue["GToFoliG"],"..."];
	Expr=x;
