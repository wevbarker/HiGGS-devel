...
PlaceholderBracketActivate=Join[PlaceholderBracketActivate,InertMakeRule[{Evaluate[ToExpression[StringReplace["RD[-g,-h,-i,-j,-x1,-y1,-z1]S1[x1]S2[y1]S3[z1]",PlaceholderBracketRules]]],Evaluate[ToExpression@"Temp[[1]]"]}]];
(*
