...
xAct`HiGGS`Private`ClearBuild["CompleteO3ProjectionsToggle"];
];
...
(* ::Input::Initialization:: *)
(*DefTensor[DPiPB0p[-z],M4,PrintAs\[Rule]SymbolBuild[PiPBSymb,Spin0p,"Derivative"->1]];
(*DeclareOrder[DPiPB0p[-z],1];*)
DefTensor[DPiPB1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPBSymb,Spin1p,"Derivative"->1]];
(*DeclareOrder[DPiPB1p[-z,-a,-b],1];*)
DefTensor[DPiPB1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[PiPBSymb,Spin1m,"Derivative"->1]];
(*DeclareOrder[DPiPB1m[-z,-a],1];*)
DefTensor[DPiPB2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPBSymb,Spin2p,"Derivative"->1]];
(*DeclareOrder[DPiPB2p[-z,-a,-b],1];*)
AutomaticRules[DPiPB2p,MakeRule[{DPiPB2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DPiPA0p[-z],M4,PrintAs\[Rule]SymbolBuild[PiPASymb,Spin0p,"Derivative"->1]];
(*DeclareOrder[DPiPA0p[-z],1];*)
DefTensor[DPiPA0m[-z],M4,PrintAs\[Rule]SymbolBuild[PiPASymb,Spin0m,"Derivative"->1]];
(*DeclareOrder[DPiPA0m[-z],1];*)
DefTensor[DPiPA1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPASymb,Spin1p,"Derivative"->1]];
(*DeclareOrder[DPiPA1p[-z,-a,-b],1];*)
DefTensor[DPiPA1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[PiPASymb,Spin1m,"Derivative"->1]];
(*DeclareOrder[DPiPA1m[-z,-a],1];*)
DefTensor[DPiPA2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPASymb,Spin2p,"Derivative"->1]];
(*DeclareOrder[DPiPA2p[-z,-a,-b],1];*)
DefTensor[DPiPA2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPASymb,Spin2m,"Derivative"->1]];
(*DeclareOrder[DPiPA2m[-z,-a,-b,-c],1];*)
AutomaticRules[DPiPA2m,MakeRule[{DPiPA2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DPiPA2m,MakeRule[{epsilonG[a,b,c,d]DPiPA2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DPiPA2p,MakeRule[{DPiPA2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DPiPB0pActivate=MakeRule[{CD[-z][PiPB0p[]],DPiPB0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPB1pActivate=MakeRule[{CD[-z][PiPB1p[-a,-b]],DPiPB1p[-z,-a,-b]+A[i,-a,-z]PiPB1p[-i,-b]+A[i,-b,-z]PiPB1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPB1mActivate=MakeRule[{CD[-z][PiPB1m[-a]],DPiPB1m[-z,-a]+A[i,-a,-z]PiPB1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPB2pActivate=MakeRule[{CD[-z][PiPB2p[-a,-b]],DPiPB2p[-z,-a,-b]+A[i,-a,-z]PiPB2p[-i,-b]+A[i,-b,-z]PiPB2p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA0pActivate=MakeRule[{CD[-z][PiPA0p[]],DPiPA0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA0mActivate=MakeRule[{CD[-z][PiPA0m[]],DPiPA0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA1pActivate=MakeRule[{CD[-z][PiPA1p[-a,-b]],DPiPA1p[-z,-a,-b]+A[i,-a,-z]PiPA1p[-i,-b]+A[i,-b,-z]PiPA1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA1mActivate=MakeRule[{CD[-z][PiPA1m[-a]],DPiPA1m[-z,-a]+A[i,-a,-z]PiPA1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA2pActivate=MakeRule[{CD[-z][PiPA2p[-a,-b]],DPiPA2p[-z,-a,-b]+A[i,-a,-z]PiPA2p[-i,-b]+A[i,-b,-z]PiPA2p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA2mActivate=MakeRule[{CD[-z][PiPA2m[-a,-b,-c]],DPiPA2m[-z,-a,-b,-c]+A[i,-a,-z]PiPA2m[-i,-b,-c]+A[i,-b,-z]PiPA2m[-a,-i,-c]+A[i,-c,-z]PiPA2m[-a,-b,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
DPiPB0pDeactivate=MakeRule[{DPiPB0p[-z],CD[-z][PiPB0p[]]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPB1pDeactivate=MakeRule[{DPiPB1p[-z,-a,-b],CD[-z][PiPB1p[-a,-b]]-A[i,-a,-z]PiPB1p[-i,-b]-A[i,-b,-z]PiPB1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPB1mDeactivate=MakeRule[{DPiPB1m[-z,-a],CD[-z][PiPB1m[-a]]-A[i,-a,-z]PiPB1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPB2pDeactivate=MakeRule[{DPiPB2p[-z,-a,-b],CD[-z][PiPB2p[-a,-b]]-A[i,-a,-z]PiPB2p[-i,-b]-A[i,-b,-z]PiPB2p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA0pDeactivate=MakeRule[{DPiPA0p[-z],CD[-z][PiPA0p[]]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA0mDeactivate=MakeRule[{DPiPA0m[-z],CD[-z][PiPA0m[]]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA1pDeactivate=MakeRule[{DPiPA1p[-z,-a,-b],CD[-z][PiPA1p[-a,-b]]-A[i,-a,-z]PiPA1p[-i,-b]-A[i,-b,-z]PiPA1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA1mDeactivate=MakeRule[{DPiPA1m[-z,-a],CD[-z][PiPA1m[-a]]-A[i,-a,-z]PiPA1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA2pDeactivate=MakeRule[{DPiPA2p[-z,-a,-b],CD[-z][PiPA2p[-a,-b]]-A[i,-a,-z]PiPA2p[-i,-b]-A[i,-b,-z]PiPA2p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DPiPA2mDeactivate=MakeRule[{DPiPA2m[-z,-a,-b,-c],CD[-z][PiPA2m[-a,-b,-c]]-A[i,-a,-z]PiPA2m[-i,-b,-c]-A[i,-b,-z]PiPA2m[-a,-i,-c]-A[i,-c,-z]PiPA2m[-a,-b,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(* ::Input::Initialization:: *)
(*DefTensor[DpPiPB0p[-z],M4,PrintAs\[Rule]SymbolBuild[PiPBSymb,Spin0p,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpPiPB0p[-z],1];
DeclareOrder[DPiPB0p[-z],1,"approximation"\[Rule]B[w,-z]DpPiPB0p[-w]+V[-v]B[v,-z]V[u]H[-u,w]DPiPB0p[-w]];
DefTensor[DpPiPB1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPBSymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpPiPB1p[-z,-a,-b],1];
DeclareOrder[DPiPB1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpPiPB1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DPiPB1p[-w,-a,-b]];
DefTensor[DpPiPB1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[PiPBSymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpPiPB1m[-z,-a],1];
DeclareOrder[DPiPB1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpPiPB1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DPiPB1m[-w,-a]];
DefTensor[DpPiPB2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPBSymb,Spin2p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpPiPB2p[-z,-a,-b],1];
DeclareOrder[DPiPB2p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpPiPB2p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DPiPB2p[-w,-a,-b]];
AutomaticRules[DpPiPB2p,MakeRule[{DpPiPB2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DpPiPA0p[-z],M4,PrintAs\[Rule]SymbolBuild[PiPASymb,Spin0p,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpPiPA0p[-z],1];
DeclareOrder[DPiPA0p[-z],1,"approximation"\[Rule]B[w,-z]DpPiPA0p[-w]+V[-v]B[v,-z]V[u]H[-u,w]DPiPA0p[-w]];
DefTensor[DpPiPA0m[-z],M4,PrintAs\[Rule]SymbolBuild[PiPASymb,Spin0m,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpPiPA0m[-z],1];
DeclareOrder[DPiPA0m[-z],1,"approximation"\[Rule]B[w,-z]DpPiPA0m[-w]+V[-v]B[v,-z]V[u]H[-u,w]DPiPA0m[-w]];
DefTensor[DpPiPA1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPASymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpPiPA1p[-z,-a,-b],1];
DeclareOrder[DPiPA1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpPiPA1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DPiPA1p[-w,-a,-b]];
DefTensor[DpPiPA1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[PiPASymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpPiPA1m[-z,-a],1];
DeclareOrder[DPiPA1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpPiPA1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DPiPA1m[-w,-a]];
DefTensor[DpPiPA2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPASymb,Spin2p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpPiPA2p[-z,-a,-b],1];
DeclareOrder[DPiPA2p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpPiPA2p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DPiPA2p[-w,-a,-b]];
DefTensor[DpPiPA2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[PiPASymb,Spin2m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b],V[c]}];
DeclareOrder[DpPiPA2m[-z,-a,-b,-c],1];
DeclareOrder[DPiPA2m[-z,-a,-b,-c],1,"approximation"\[Rule]B[w,-z]DpPiPA2m[-w,-a,-b,-c]+V[-v]B[v,-z]V[u]H[-u,w]DPiPA2m[-w,-a,-b,-c]];
AutomaticRules[DpPiPA2m,MakeRule[{DpPiPA2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpPiPA2m,MakeRule[{epsilonG[a,b,c,d]DpPiPA2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpPiPA2p,MakeRule[{DpPiPA2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DpPiPB0pActivate=MakeRule[{G3[-y,z]DPiPB0p[-z],G3[-y,z]B[x,-z]DpPiPB0p[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPB1pActivate=MakeRule[{G3[-y,z]DPiPB1p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpPiPB1p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DPiPB1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPB1mActivate=MakeRule[{G3[-y,z]DPiPB1m[-z,-a],Evaluate[G3[-y,z]B[x,-z]DpPiPB1m[-x,-a]+(G[-a,i]-PPara[-a,i])G3[-y,z]DPiPB1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPB2pActivate=MakeRule[{G3[-y,z]DPiPB2p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpPiPB2p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DPiPB2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA0pActivate=MakeRule[{G3[-y,z]DPiPA0p[-z],G3[-y,z]B[x,-z]DpPiPA0p[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA0mActivate=MakeRule[{G3[-y,z]DPiPA0m[-z],G3[-y,z]B[x,-z]DpPiPA0m[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA1pActivate=MakeRule[{G3[-y,z]DPiPA1p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpPiPA1p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DPiPA1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA1mActivate=MakeRule[{G3[-y,z]DPiPA1m[-z,-a],Evaluate[G3[-y,z]B[x,-z]DpPiPA1m[-x,-a]+(G[-a,i]-PPara[-a,i])G3[-y,z]DPiPA1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA2pActivate=MakeRule[{G3[-y,z]DPiPA2p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpPiPA2p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DPiPA2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA2mActivate=MakeRule[{G3[-y,z]DPiPA2m[-z,-a,-b,-c],Evaluate[G3[-y,z]B[x,-z]DpPiPA2m[-x,-a,-b,-c]+(G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DPiPA2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
DpPiPB0pDeactivate=MakeRule[{DpPiPB0p[-w],PPara[-w,v]H[-v,y]G3[-y,z]DPiPB0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPB1pDeactivate=MakeRule[{DpPiPB1p[-w,-a,-b],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DPiPB1p[-z,-a,-b]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DPiPB1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPB1mDeactivate=MakeRule[{DpPiPB1m[-w,-a],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DPiPB1m[-z,-a]-PPara[-w,v]H[-v,y](G[-a,i]-PPara[-a,i])G3[-y,z]DPiPB1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPB2pDeactivate=MakeRule[{DpPiPB2p[-w,-a,-b],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DPiPB2p[-z,-a,-b]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DPiPB2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA0pDeactivate=MakeRule[{DpPiPA0p[-w],PPara[-w,v]H[-v,y]G3[-y,z]DPiPA0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA0mDeactivate=MakeRule[{DpPiPA0m[-w],PPara[-w,v]H[-v,y]G3[-y,z]DPiPA0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA1pDeactivate=MakeRule[{DpPiPA1p[-w,-a,-b],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DPiPA1p[-z,-a,-b]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DPiPA1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA1mDeactivate=MakeRule[{DpPiPA1m[-w,-a],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DPiPA1m[-z,-a]-PPara[-w,v]H[-v,y](G[-a,i]-PPara[-a,i])G3[-y,z]DPiPA1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA2pDeactivate=MakeRule[{DpPiPA2p[-w,-a,-b],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DPiPA2p[-z,-a,-b]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DPiPA2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpPiPA2mDeactivate=MakeRule[{DpPiPA2m[-w,-a,-b,-c],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DPiPA2m[-z,-a,-b,-c]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DPiPA2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(* ::Input::Initialization:: *)
(*DefTensor[DUB0p[-z],M4,PrintAs\[Rule]SymbolBuild[UBSymb,Spin0p,"Derivative"->1]];
DeclareOrder[DUB0p[-z],1];
DefTensor[DUB1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UBSymb,Spin1p,"Derivative"->1]];
DeclareOrder[DUB1p[-z,-a,-b],1];
DefTensor[DUB1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[UBSymb,Spin1m,"Derivative"->1]];
DeclareOrder[DUB1m[-z,-a],1];
DefTensor[DUB2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UBSymb,Spin2p,"Derivative"->1]];
DeclareOrder[DUB2p[-z,-a,-b],1];
AutomaticRules[DUB2p,MakeRule[{DUB2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DUA0p[-z],M4,PrintAs\[Rule]SymbolBuild[UASymb,Spin0p,"Derivative"->1]];
DeclareOrder[DUA0p[-z],1];
DefTensor[DUA0m[-z],M4,PrintAs\[Rule]SymbolBuild[UASymb,Spin0m,"Derivative"->1]];
DeclareOrder[DUA0m[-z],1];
DefTensor[DUA1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UASymb,Spin1p,"Derivative"->1]];
DeclareOrder[DUA1p[-z,-a,-b],1];
DefTensor[DUA1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[UASymb,Spin1m,"Derivative"->1]];
DeclareOrder[DUA1m[-z,-a],1];
DefTensor[DUA2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UASymb,Spin2p,"Derivative"->1]];
DeclareOrder[DUA2p[-z,-a,-b],1];
DefTensor[DUA2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UASymb,Spin2m,"Derivative"->1]];
DeclareOrder[DUA2m[-z,-a,-b,-c],1];
AutomaticRules[DUA2m,MakeRule[{DUA2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DUA2m,MakeRule[{epsilonG[a,b,c,d]DUA2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DUA2p,MakeRule[{DUA2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
xAct`HiGGS`Private`ClearBuild[];*)


(* ::Input::Initialization:: *)
(*DefTensor[DpUB0p[-z],M4,PrintAs\[Rule]SymbolBuild[UBSymb,Spin0p,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpUB0p[-z],1];
DeclareOrder[DUB0p[-z],1,"approximation"\[Rule]B[w,-z]DpUB0p[-w]+V[-v]B[v,-z]V[u]H[-u,w]DUB0p[-w]];
DefTensor[DpUB1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UBSymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpUB1p[-z,-a,-b],1];
DeclareOrder[DUB1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpUB1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DUB1p[-w,-a,-b]];
DefTensor[DpUB1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[UBSymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpUB1m[-z,-a],1];
DeclareOrder[DUB1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpUB1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DUB1m[-w,-a]];
DefTensor[DpUB2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UBSymb,Spin2p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpUB2p[-z,-a,-b],1];
DeclareOrder[DUB2p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpUB2p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DUB2p[-w,-a,-b]];
AutomaticRules[DpUB2p,MakeRule[{DpUB2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DpUA0p[-z],M4,PrintAs\[Rule]SymbolBuild[UASymb,Spin0p,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpUA0p[-z],1];
DeclareOrder[DUA0p[-z],1,"approximation"\[Rule]B[w,-z]DpUA0p[-w]+V[-v]B[v,-z]V[u]H[-u,w]DUA0p[-w]];
DefTensor[DpUA0m[-z],M4,PrintAs\[Rule]SymbolBuild[UASymb,Spin0m,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpUA0m[-z],1];
DeclareOrder[DUA0m[-z],1,"approximation"\[Rule]B[w,-z]DpUA0m[-w]+V[-v]B[v,-z]V[u]H[-u,w]DUA0m[-w]];
DefTensor[DpUA1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UASymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpUA1p[-z,-a,-b],1];
DeclareOrder[DUA1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpUA1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DUA1p[-w,-a,-b]];
DefTensor[DpUA1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[UASymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpUA1m[-z,-a],1];
DeclareOrder[DUA1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpUA1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DUA1m[-w,-a]];
DefTensor[DpUA2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UASymb,Spin2p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpUA2p[-z,-a,-b],1];
DeclareOrder[DUA2p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpUA2p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DUA2p[-w,-a,-b]];
DefTensor[DpUA2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[UASymb,Spin2m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b],V[c]}];
DeclareOrder[DpUA2m[-z,-a,-b,-c],1];
DeclareOrder[DUA2m[-z,-a,-b,-c],1,"approximation"\[Rule]B[w,-z]DpUA2m[-w,-a,-b,-c]+V[-v]B[v,-z]V[u]H[-u,w]DUA2m[-w,-a,-b,-c]];
AutomaticRules[DpUA2m,MakeRule[{DpUA2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpUA2m,MakeRule[{epsilonG[a,b,c,d]DpUA2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpUA2p,MakeRule[{DpUA2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
xAct`HiGGS`Private`ClearBuild[];*)


(* ::Input::Initialization:: *)
(*DefTensor[DTP0m[-z],M4,PrintAs\[Rule]SymbolBuild[TPSymb,Spin0m,"Derivative"->1]];
(*DeclareOrder[DTP0m[-z],1];*)
DefTensor[DTP1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TPSymb,Spin1p,"Derivative"->1]];
(*DeclareOrder[DTP1p[-z,-a,-b],1];*)
DefTensor[DTP1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[TPSymb,Spin1m,"Derivative"->1]];
(*DeclareOrder[DTP1m[-z,-a],1];*)
DefTensor[DTP2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TPSymb,Spin2m,"Derivative"->1]];
(*DeclareOrder[DTP2m[-z,-a,-b,-c],1];*)
AutomaticRules[DTP2m,MakeRule[{DTP2m[a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DTP2m,MakeRule[{epsilonG[a,b,c,d]DTP2m[-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DRP0p[-z],M4,PrintAs\[Rule]SymbolBuild[RPSymb,Spin0p,"Derivative"->1]];
(*DeclareOrder[DRP0p[-z],1];*)
DefTensor[DRP0m[-z],M4,PrintAs\[Rule]SymbolBuild[RPSymb,Spin0m,"Derivative"->1]];
(*DeclareOrder[DRP0m[-z],1];*)
DefTensor[DRP1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RPSymb,Spin1p,"Derivative"->1]];
(*DeclareOrder[DRP1p[-z,-a,-b],1];*)
DefTensor[DRP1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[RPSymb,Spin1m,"Derivative"->1]];
(*DeclareOrder[DRP1m[-z,-a],1];*)
DefTensor[DRP2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RPSymb,Spin2p,"Derivative"->1]];
(*DeclareOrder[DRP2p[-z,-a,-b],1];*)
DefTensor[DRP2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RPSymb,Spin2m,"Derivative"->1]];
(*DeclareOrder[DRP2m[-z,-a,-b,-c],1];*)
AutomaticRules[DRP2m,MakeRule[{DRP2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DRP2m,MakeRule[{epsilonG[a,b,c,d]DRP2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DRP2p,MakeRule[{DRP2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DTP0mActivate=MakeRule[{CD[-z][TP0m[]],DTP0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTP1pActivate=MakeRule[{CD[-z][TP1p[-a,-b]],DTP1p[-z,-a,-b]+A[i,-a,-z]TP1p[-i,-b]+A[i,-b,-z]TP1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTP1mActivate=MakeRule[{CD[-z][TP1m[-a]],DTP1m[-z,-a]+A[i,-a,-z]TP1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTP2mActivate=MakeRule[{CD[-z][TP2m[-a,-b,-c]],DTP2m[-z,-a,-b,-c]+A[i,-a,-z]TP2m[-i,-b,-c]+A[i,-b,-z]TP2m[-a,-i,-c]+A[i,-c,-z]TP2m[-a,-b,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRP0pActivate=MakeRule[{CD[-z][RP0p[]],DRP0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRP0mActivate=MakeRule[{CD[-z][RP0m[]],DRP0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRP1pActivate=MakeRule[{CD[-z][RP1p[-a,-b]],DRP1p[-z,-a,-b]+A[i,-a,-z]RP1p[-i,-b]+A[i,-b,-z]RP1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRP1mActivate=MakeRule[{CD[-z][RP1m[-a]],DRP1m[-z,-a]+A[i,-a,-z]RP1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRP2pActivate=MakeRule[{CD[-z][RP2p[-a,-b]],DRP2p[-z,-a,-b]+A[i,-a,-z]RP2p[-i,-b]+A[i,-b,-z]RP2p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRP2mActivate=MakeRule[{CD[-z][RP2m[-a,-b,-c]],DRP2m[-z,-a,-b,-c]+A[i,-a,-z]RP2m[-i,-b,-c]+A[i,-b,-z]RP2m[-a,-i,-c]+A[i,-c,-z]RP2m[-a,-b,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(* ::Input::Initialization:: *)
(*DefTensor[DTLambdaP0m[-z],M4,PrintAs\[Rule]SymbolBuild[TLambdaPSymb,Spin0m,"Derivative"->1]];
(*DeclareOrder[DTLambdaP0m[-z],1];*)
DefTensor[DTLambdaP1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TLambdaPSymb,Spin1p,"Derivative"->1]];
(*DeclareOrder[DTLambdaP1p[-z,-a,-b],1];*)
DefTensor[DTLambdaP1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[TLambdaPSymb,Spin1m,"Derivative"->1]];
(*DeclareOrder[DTLambdaP1m[-z,-a],1];*)
DefTensor[DTLambdaP2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TLambdaPSymb,Spin2m,"Derivative"->1]];
(*DeclareOrder[DTLambdaP2m[-z,-a,-b,-c],1];*)
AutomaticRules[DTLambdaP2m,MakeRule[{DTLambdaP2m[a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DTLambdaP2m,MakeRule[{epsilonG[a,b,c,d]DTLambdaP2m[-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DRLambdaP0p[-z],M4,PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin0p,"Derivative"->1]];
(*DeclareOrder[DRLambdaP0p[-z],1];*)
DefTensor[DRLambdaP0m[-z],M4,PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin0m,"Derivative"->1]];
(*DeclareOrder[DRLambdaP0m[-z],1];*)
DefTensor[DRLambdaP1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin1p,"Derivative"->1]];
(*DeclareOrder[DRLambdaP1p[-z,-a,-b],1];*)
DefTensor[DRLambdaP1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin1m,"Derivative"->1]];
(*DeclareOrder[DRLambdaP1m[-z,-a],1];*)
DefTensor[DRLambdaP2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin2p,"Derivative"->1]];
(*DeclareOrder[DRLambdaP2p[-z,-a,-b],1];*)
DefTensor[DRLambdaP2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin2m,"Derivative"->1]];
(*DeclareOrder[DRLambdaP2m[-z,-a,-b,-c],1];*)
AutomaticRules[DRLambdaP2m,MakeRule[{DRLambdaP2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DRLambdaP2m,MakeRule[{epsilonG[a,b,c,d]DRLambdaP2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DRLambdaP2p,MakeRule[{DRLambdaP2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DTLambdaP0mActivate=MakeRule[{CD[-z][TLambdaP0m[]],DTLambdaP0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTLambdaP1pActivate=MakeRule[{CD[-z][TLambdaP1p[-a,-b]],DTLambdaP1p[-z,-a,-b]+A[i,-a,-z]TLambdaP1p[-i,-b]+A[i,-b,-z]TLambdaP1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTLambdaP1mActivate=MakeRule[{CD[-z][TLambdaP1m[-a]],DTLambdaP1m[-z,-a]+A[i,-a,-z]TLambdaP1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTLambdaP2mActivate=MakeRule[{CD[-z][TLambdaP2m[-a,-b,-c]],DTLambdaP2m[-z,-a,-b,-c]+A[i,-a,-z]TLambdaP2m[-i,-b,-c]+A[i,-b,-z]TLambdaP2m[-a,-i,-c]+A[i,-c,-z]TLambdaP2m[-a,-b,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaP0pActivate=MakeRule[{CD[-z][RLambdaP0p[]],DRLambdaP0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaP0mActivate=MakeRule[{CD[-z][RLambdaP0m[]],DRLambdaP0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaP1pActivate=MakeRule[{CD[-z][RLambdaP1p[-a,-b]],DRLambdaP1p[-z,-a,-b]+A[i,-a,-z]RLambdaP1p[-i,-b]+A[i,-b,-z]RLambdaP1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaP1mActivate=MakeRule[{CD[-z][RLambdaP1m[-a]],DRLambdaP1m[-z,-a]+A[i,-a,-z]RLambdaP1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaP2pActivate=MakeRule[{CD[-z][RLambdaP2p[-a,-b]],DRLambdaP2p[-z,-a,-b]+A[i,-a,-z]RLambdaP2p[-i,-b]+A[i,-b,-z]RLambdaP2p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaP2mActivate=MakeRule[{CD[-z][RLambdaP2m[-a,-b,-c]],DRLambdaP2m[-z,-a,-b,-c]+A[i,-a,-z]RLambdaP2m[-i,-b,-c]+A[i,-b,-z]RLambdaP2m[-a,-i,-c]+A[i,-c,-z]RLambdaP2m[-a,-b,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(* ::Input::Initialization:: *)
(*DefTensor[DTLambdaPerp0p[-z],M4,PrintAs\[Rule]SymbolBuild[TLambdaPerpSymb,Spin0p,"Derivative"->1]];
(*DeclareOrder[DTLambdaPerp0p[-z],1];*)
DefTensor[DTLambdaPerp1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TLambdaPerpSymb,Spin1p,"Derivative"->1]];
(*DeclareOrder[DTLambdaPerp1p[-z,-a,-b],1];*)
DefTensor[DTLambdaPerp1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[TLambdaPerpSymb,Spin1m,"Derivative"->1]];
(*DeclareOrder[DTLambdaPerp1m[-z,-a],1];*)
DefTensor[DTLambdaPerp2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TLambdaPerpSymb,Spin2p,"Derivative"->1]];
(*DeclareOrder[DTLambdaPerp2p[-z,-a,-b],1];*)
AutomaticRules[DTLambdaPerp2p,MakeRule[{DTLambdaPerp2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DRLambdaPerp0p[-z],M4,PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin0p,"Derivative"->1]];
(*DeclareOrder[DRLambdaPerp0p[-z],1];*)
DefTensor[DRLambdaPerp0m[-z],M4,PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin0m,"Derivative"->1]];
(*DeclareOrder[DRLambdaPerp0m[-z],1];*)
DefTensor[DRLambdaPerp1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin1p,"Derivative"->1]];
(*DeclareOrder[DRLambdaPerp1p[-z,-a,-b],1];*)
DefTensor[DRLambdaPerp1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin1m,"Derivative"->1]];
(*DeclareOrder[DRLambdaPerp1m[-z,-a],1];*)
DefTensor[DRLambdaPerp2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin2p,"Derivative"->1]];
(*DeclareOrder[DRLambdaPerp2p[-z,-a,-b],1];*)
DefTensor[DRLambdaPerp2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin2m,"Derivative"->1]];
(*DeclareOrder[DRLambdaPerp2m[-z,-a,-b,-c],1];*)
AutomaticRules[DRLambdaPerp2m,MakeRule[{DRLambdaPerp2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DRLambdaPerp2m,MakeRule[{epsilonG[a,b,c,d]DRLambdaPerp2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DRLambdaPerp2p,MakeRule[{DRLambdaPerp2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DTLambdaPerp0pActivate=MakeRule[{CD[-z][TLambdaPerp0p[]],DTLambdaPerp0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTLambdaPerp1pActivate=MakeRule[{CD[-z][TLambdaPerp1p[-a,-b]],DTLambdaPerp1p[-z,-a,-b]+A[i,-a,-z]TLambdaPerp1p[-i,-b]+A[i,-b,-z]TLambdaPerp1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTLambdaPerp1mActivate=MakeRule[{CD[-z][TLambdaPerp1m[-a]],DTLambdaPerp1m[-z,-a]+A[i,-a,-z]TLambdaPerp1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DTLambdaPerp2pActivate=MakeRule[{CD[-z][TLambdaPerp2p[-a,-b]],DTLambdaPerp2p[-z,-a,-b]+A[i,-a,-z]TLambdaPerp2p[-i,-b]+A[i,-b,-z]TLambdaPerp2p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaPerp0pActivate=MakeRule[{CD[-z][RLambdaPerp0p[]],DRLambdaPerp0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaPerp0mActivate=MakeRule[{CD[-z][RLambdaPerp0m[]],DRLambdaPerp0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaPerp1pActivate=MakeRule[{CD[-z][RLambdaPerp1p[-a,-b]],DRLambdaPerp1p[-z,-a,-b]+A[i,-a,-z]RLambdaPerp1p[-i,-b]+A[i,-b,-z]RLambdaPerp1p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaPerp1mActivate=MakeRule[{CD[-z][RLambdaPerp1m[-a]],DRLambdaPerp1m[-z,-a]+A[i,-a,-z]RLambdaPerp1m[-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaPerp2pActivate=MakeRule[{CD[-z][RLambdaPerp2p[-a,-b]],DRLambdaPerp2p[-z,-a,-b]+A[i,-a,-z]RLambdaPerp2p[-i,-b]+A[i,-b,-z]RLambdaPerp2p[-a,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DRLambdaPerp2mActivate=MakeRule[{CD[-z][RLambdaPerp2m[-a,-b,-c]],DRLambdaPerp2m[-z,-a,-b,-c]+A[i,-a,-z]RLambdaPerp2m[-i,-b,-c]+A[i,-b,-z]RLambdaPerp2m[-a,-i,-c]+A[i,-c,-z]RLambdaPerp2m[-a,-b,-i]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(* ::Input::Initialization:: *)
(*DefTensor[DHComp[-z],M4,PrintAs\[Rule]"\[CapitalDifferentialD]H"];
DHCompActivate=MakeRule[{CD[-z][HComp[]],DHComp[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
xAct`HiGGS`Private`ClearBuild[];*)


(* ::Input::Initialization:: *)
(*DefTensor[DpTP0m[-z],M4,PrintAs\[Rule]SymbolBuild[TPSymb,Spin0m,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpTP0m[-z],1];
DeclareOrder[DTP0m[-z],1,"approximation"\[Rule]B[w,-z]DpTP0m[-w]+V[-v]B[v,-z]V[u]H[-u,w]DTP0m[-w]];
DefTensor[DpTP1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TPSymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpTP1p[-z,-a,-b],1];
DeclareOrder[DTP1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpTP1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DTP1p[-w,-a,-b]];
DefTensor[DpTP1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[TPSymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpTP1m[-z,-a],1];
DeclareOrder[DTP1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpTP1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DTP1m[-w,-a]];
DefTensor[DpTP2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TPSymb,Spin2m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b],V[c]}];
DeclareOrder[DpTP2m[-z,-a,-b,-c],1];
DeclareOrder[DTP2m[-z,-a,-b,-c],1,"approximation"\[Rule]B[w,-z]DpTP2m[-w,-a,-b,-c]+V[-v]B[v,-z]V[u]H[-u,w]DTP2m[-w,-a,-b,-c]];
AutomaticRules[DpTP2m,MakeRule[{DpTP2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpTP2m,MakeRule[{epsilonG[a,b,c,d]DpTP2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DpRP0p[-z],M4,PrintAs\[Rule]SymbolBuild[RPSymb,Spin0p,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpRP0p[-z],1];
DeclareOrder[DRP0p[-z],1,"approximation"\[Rule]B[w,-z]DpRP0p[-w]+V[-v]B[v,-z]V[u]H[-u,w]DRP0p[-w]];
DefTensor[DpRP0m[-z],M4,PrintAs\[Rule]SymbolBuild[RPSymb,Spin0m,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpRP0m[-z],1];
DeclareOrder[DRP0m[-z],1,"approximation"\[Rule]B[w,-z]DpRP0m[-w]+V[-v]B[v,-z]V[u]H[-u,w]DRP0m[-w]];
DefTensor[DpRP1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RPSymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpRP1p[-z,-a,-b],1];
DeclareOrder[DRP1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpRP1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DRP1p[-w,-a,-b]];
DefTensor[DpRP1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[RPSymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpRP1m[-z,-a],1];
DeclareOrder[DRP1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpRP1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DRP1m[-w,-a]];
DefTensor[DpRP2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RPSymb,Spin2p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpRP2p[-z,-a,-b],1];
DeclareOrder[DRP2p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpRP2p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DRP2p[-w,-a,-b]];
DefTensor[DpRP2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RPSymb,Spin2m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b],V[c]}];
DeclareOrder[DpRP2m[-z,-a,-b,-c],1];
DeclareOrder[DRP2m[-z,-a,-b,-c],1,"approximation"\[Rule]B[w,-z]DpRP2m[-w,-a,-b,-c]+V[-v]B[v,-z]V[u]H[-u,w]DRP2m[-w,-a,-b,-c]];
AutomaticRules[DpRP2m,MakeRule[{DpRP2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpRP2m,MakeRule[{epsilonG[a,b,c,d]DpRP2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpRP2p,MakeRule[{DpRP2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DpTP0mActivate=MakeRule[{G3[-y,z]DTP0m[-z],G3[-y,z]B[x,-z]DpTP0m[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTP1pActivate=MakeRule[{G3[-y,z]DTP1p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpTP1p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DTP1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTP1mActivate=MakeRule[{G3[-y,z]DTP1m[-z,-a],Evaluate[G3[-y,z]B[x,-z]DpTP1m[-x,-a]+(G[-a,i]-PPara[-a,i])G3[-y,z]DTP1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTP2mActivate=MakeRule[{G3[-y,z]DTP2m[-z,-a,-b,-c],Evaluate[G3[-y,z]B[x,-z]DpTP2m[-x,-a,-b,-c]+(G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DTP2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP0pActivate=MakeRule[{G3[-y,z]DRP0p[-z],G3[-y,z]B[x,-z]DpRP0p[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP0mActivate=MakeRule[{G3[-y,z]DRP0m[-z],G3[-y,z]B[x,-z]DpRP0m[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP1pActivate=MakeRule[{G3[-y,z]DRP1p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpRP1p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DRP1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP1mActivate=MakeRule[{G3[-y,z]DRP1m[-z,-a],Evaluate[G3[-y,z]B[x,-z]DpRP1m[-x,-a]+(G[-a,i]-PPara[-a,i])G3[-y,z]DRP1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP2pActivate=MakeRule[{G3[-y,z]DRP2p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpRP2p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DRP2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP2mActivate=MakeRule[{G3[-y,z]DRP2m[-z,-a,-b,-c],Evaluate[G3[-y,z]B[x,-z]DpRP2m[-x,-a,-b,-c]+(G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DRP2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(*again this should be extended over other derivatives, multiply the above by PPara[-w,v]H[-v,y]*)
DpTP0mDeactivate=MakeRule[{DpTP0m[-w],PPara[-w,v]H[-v,y]G3[-y,z]DTP0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTP1pDeactivate=MakeRule[{DpTP1p[-w,-a,-b],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DTP1p[-z,-a,-b]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DTP1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTP1mDeactivate=MakeRule[{DpTP1m[-w,-a],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DTP1m[-z,-a]-PPara[-w,v]H[-v,y](G[-a,i]-PPara[-a,i])G3[-y,z]DTP1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTP2mDeactivate=MakeRule[{DpTP2m[-w,-a,-b,-c],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DTP2m[-z,-a,-b,-c]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DTP2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP0pDeactivate=MakeRule[{DpRP0p[-w],PPara[-w,v]H[-v,y]G3[-y,z]DRP0p[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP0mDeactivate=MakeRule[{DpRP0m[-w],PPara[-w,v]H[-v,y]G3[-y,z]DRP0m[-z]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP1pDeactivate=MakeRule[{DpRP1p[-w,-a,-b],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DRP1p[-z,-a,-b]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DRP1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP1mDeactivate=MakeRule[{DpRP1m[-w,-a],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DRP1m[-z,-a]-PPara[-w,v]H[-v,y](G[-a,i]-PPara[-a,i])G3[-y,z]DRP1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP2pDeactivate=MakeRule[{DpRP2p[-w,-a,-b],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DRP2p[-z,-a,-b]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DRP2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRP2mDeactivate=MakeRule[{DpRP2m[-w,-a,-b,-c],Evaluate[PPara[-w,v]H[-v,y]G3[-y,z]DRP2m[-z,-a,-b,-c]-PPara[-w,v]H[-v,y](G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DRP2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(* ::Input::Initialization:: *)
(*DefTensor[DpTLambdaP0m[-z],M4,PrintAs\[Rule]SymbolBuild[TLambdaPSymb,Spin0m,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpTLambdaP0m[-z],1];
DeclareOrder[DTLambdaP0m[-z],1,"approximation"\[Rule]B[w,-z]DpTLambdaP0m[-w]+V[-v]B[v,-z]V[u]H[-u,w]DTLambdaP0m[-w]];
DefTensor[DpTLambdaP1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TLambdaPSymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpTLambdaP1p[-z,-a,-b],1];
DeclareOrder[DTLambdaP1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpTLambdaP1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DTLambdaP1p[-w,-a,-b]];
DefTensor[DpTLambdaP1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[TLambdaPSymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpTLambdaP1m[-z,-a],1];
DeclareOrder[DTLambdaP1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpTLambdaP1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DTLambdaP1m[-w,-a]];
DefTensor[DpTLambdaP2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TLambdaPSymb,Spin2m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b],V[c]}];
DeclareOrder[DpTLambdaP2m[-z,-a,-b,-c],1];
DeclareOrder[DTLambdaP2m[-z,-a,-b,-c],1,"approximation"\[Rule]B[w,-z]DpTLambdaP2m[-w,-a,-b,-c]+V[-v]B[v,-z]V[u]H[-u,w]DTLambdaP2m[-w,-a,-b,-c]];
AutomaticRules[DpTLambdaP2m,MakeRule[{DpTLambdaP2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpTLambdaP2m,MakeRule[{epsilonG[a,b,c,d]DpTLambdaP2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DpRLambdaP0p[-z],M4,PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin0p,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpRLambdaP0p[-z],1];
DeclareOrder[DRLambdaP0p[-z],1,"approximation"\[Rule]B[w,-z]DpRLambdaP0p[-w]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaP0p[-w]];
DefTensor[DpRLambdaP0m[-z],M4,PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin0m,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpRLambdaP0m[-z],1];
DeclareOrder[DRLambdaP0m[-z],1,"approximation"\[Rule]B[w,-z]DpRLambdaP0m[-w]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaP0m[-w]];
DefTensor[DpRLambdaP1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpRLambdaP1p[-z,-a,-b],1];
DeclareOrder[DRLambdaP1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpRLambdaP1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaP1p[-w,-a,-b]];
DefTensor[DpRLambdaP1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpRLambdaP1m[-z,-a],1];
DeclareOrder[DRLambdaP1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpRLambdaP1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaP1m[-w,-a]];
DefTensor[DpRLambdaP2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin2p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpRLambdaP2p[-z,-a,-b],1];
DeclareOrder[DRLambdaP2p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpRLambdaP2p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaP2p[-w,-a,-b]];
DefTensor[DpRLambdaP2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPSymb,Spin2m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b],V[c]}];
DeclareOrder[DpRLambdaP2m[-z,-a,-b,-c],1];
DeclareOrder[DRLambdaP2m[-z,-a,-b,-c],1,"approximation"\[Rule]B[w,-z]DpRLambdaP2m[-w,-a,-b,-c]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaP2m[-w,-a,-b,-c]];
AutomaticRules[DpRLambdaP2m,MakeRule[{DpRLambdaP2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpRLambdaP2m,MakeRule[{epsilonG[a,b,c,d]DpRLambdaP2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpRLambdaP2p,MakeRule[{DpRLambdaP2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DpTLambdaP0mActivate=MakeRule[{G3[-y,z]DTLambdaP0m[-z],G3[-y,z]B[x,-z]DpTLambdaP0m[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTLambdaP1pActivate=MakeRule[{G3[-y,z]DTLambdaP1p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpTLambdaP1p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DTLambdaP1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTLambdaP1mActivate=MakeRule[{G3[-y,z]DTLambdaP1m[-z,-a],Evaluate[G3[-y,z]B[x,-z]DpTLambdaP1m[-x,-a]+(G[-a,i]-PPara[-a,i])G3[-y,z]DTLambdaP1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTLambdaP2mActivate=MakeRule[{G3[-y,z]DTLambdaP2m[-z,-a,-b,-c],Evaluate[G3[-y,z]B[x,-z]DpTLambdaP2m[-x,-a,-b,-c]+(G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DTLambdaP2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaP0pActivate=MakeRule[{G3[-y,z]DRLambdaP0p[-z],G3[-y,z]B[x,-z]DpRLambdaP0p[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaP0mActivate=MakeRule[{G3[-y,z]DRLambdaP0m[-z],G3[-y,z]B[x,-z]DpRLambdaP0m[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaP1pActivate=MakeRule[{G3[-y,z]DRLambdaP1p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpRLambdaP1p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DRLambdaP1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaP1mActivate=MakeRule[{G3[-y,z]DRLambdaP1m[-z,-a],Evaluate[G3[-y,z]B[x,-z]DpRLambdaP1m[-x,-a]+(G[-a,i]-PPara[-a,i])G3[-y,z]DRLambdaP1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaP2pActivate=MakeRule[{G3[-y,z]DRLambdaP2p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpRLambdaP2p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DRLambdaP2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaP2mActivate=MakeRule[{G3[-y,z]DRLambdaP2m[-z,-a,-b,-c],Evaluate[G3[-y,z]B[x,-z]DpRLambdaP2m[-x,-a,-b,-c]+(G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DRLambdaP2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(* ::Input::Initialization:: *)
(*DefTensor[DpTLambdaPerp0p[-z],M4,PrintAs\[Rule]SymbolBuild[TLambdaPerpSymb,Spin0p,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpTLambdaPerp0p[-z],1];
DeclareOrder[DTLambdaPerp0p[-z],1,"approximation"\[Rule]B[w,-z]DpTLambdaPerp0p[-w]+V[-v]B[v,-z]V[u]H[-u,w]DTLambdaPerp0p[-w]];
DefTensor[DpTLambdaPerp1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TLambdaPerpSymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpTLambdaPerp1p[-z,-a,-b],1];
DeclareOrder[DTLambdaPerp1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpTLambdaPerp1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DTLambdaPerp1p[-w,-a,-b]];
DefTensor[DpTLambdaPerp1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[TLambdaPerpSymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpTLambdaPerp1m[-z,-a],1];
DeclareOrder[DTLambdaPerp1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpTLambdaPerp1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DTLambdaPerp1m[-w,-a]];
DefTensor[DpTLambdaPerp2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[TLambdaPerpSymb,Spin2p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpTLambdaPerp2p[-z,-a,-b],1];
DeclareOrder[DTLambdaPerp2p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpTLambdaPerp2p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DTLambdaPerp2p[-w,-a,-b]];
AutomaticRules[DpTLambdaPerp2p,MakeRule[{DpTLambdaPerp2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DefTensor[DpRLambdaPerp0p[-z],M4,PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin0p,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpRLambdaPerp0p[-z],1];
DeclareOrder[DRLambdaPerp0p[-z],1,"approximation"\[Rule]B[w,-z]DpRLambdaPerp0p[-w]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaPerp0p[-w]];
DefTensor[DpRLambdaPerp0m[-z],M4,PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin0m,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DeclareOrder[DpRLambdaPerp0m[-z],1];
DeclareOrder[DRLambdaPerp0m[-z],1,"approximation"\[Rule]B[w,-z]DpRLambdaPerp0m[-w]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaPerp0m[-w]];
DefTensor[DpRLambdaPerp1p[-z,-a,-b],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin1p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpRLambdaPerp1p[-z,-a,-b],1];
DeclareOrder[DRLambdaPerp1p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpRLambdaPerp1p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaPerp1p[-w,-a,-b]];
DefTensor[DpRLambdaPerp1m[-z,-a],M4,PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin1m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a]}];
DeclareOrder[DpRLambdaPerp1m[-z,-a],1];
DeclareOrder[DRLambdaPerp1m[-z,-a],1,"approximation"\[Rule]B[w,-z]DpRLambdaPerp1m[-w,-a]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaPerp1m[-w,-a]];
DefTensor[DpRLambdaPerp2p[-z,-a,-b],M4,Symmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin2p,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b]}];
DeclareOrder[DpRLambdaPerp2p[-z,-a,-b],1];
DeclareOrder[DRLambdaPerp2p[-z,-a,-b],1,"approximation"\[Rule]B[w,-z]DpRLambdaPerp2p[-w,-a,-b]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaPerp2p[-w,-a,-b]];
DefTensor[DpRLambdaPerp2m[-z,-a,-b,-c],M4,Antisymmetric[{-a,-b}],PrintAs\[Rule]SymbolBuild[RLambdaPerpSymb,Spin2m,"Derivative"->2],OrthogonalTo\[Rule]{V[z],V[a],V[b],V[c]}];
DeclareOrder[DpRLambdaPerp2m[-z,-a,-b,-c],1];
DeclareOrder[DRLambdaPerp2m[-z,-a,-b,-c],1,"approximation"\[Rule]B[w,-z]DpRLambdaPerp2m[-w,-a,-b,-c]+V[-v]B[v,-z]V[u]H[-u,w]DRLambdaPerp2m[-w,-a,-b,-c]];
AutomaticRules[DpRLambdaPerp2m,MakeRule[{DpRLambdaPerp2m[-z,a,-b,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpRLambdaPerp2m,MakeRule[{epsilonG[a,b,c,d]DpRLambdaPerp2m[-z,-a,-b,-c],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
AutomaticRules[DpRLambdaPerp2p,MakeRule[{DpRLambdaPerp2p[-z,a,-a],0},MetricOn\[Rule]All,ContractMetrics\[Rule]True]];
DpTLambdaPerp0pActivate=MakeRule[{G3[-y,z]DTLambdaPerp0p[-z],G3[-y,z]B[x,-z]DpTLambdaPerp0p[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTLambdaPerp1pActivate=MakeRule[{G3[-y,z]DTLambdaPerp1p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpTLambdaPerp1p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DTLambdaPerp1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTLambdaPerp1mActivate=MakeRule[{G3[-y,z]DTLambdaPerp1m[-z,-a],Evaluate[G3[-y,z]B[x,-z]DpTLambdaPerp1m[-x,-a]+(G[-a,i]-PPara[-a,i])G3[-y,z]DTLambdaPerp1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpTLambdaPerp2pActivate=MakeRule[{G3[-y,z]DTLambdaPerp2p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpTLambdaPerp2p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DTLambdaPerp2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaPerp0pActivate=MakeRule[{G3[-y,z]DRLambdaPerp0p[-z],G3[-y,z]B[x,-z]DpRLambdaPerp0p[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaPerp0mActivate=MakeRule[{G3[-y,z]DRLambdaPerp0m[-z],G3[-y,z]B[x,-z]DpRLambdaPerp0m[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaPerp1pActivate=MakeRule[{G3[-y,z]DRLambdaPerp1p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpRLambdaPerp1p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DRLambdaPerp1p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaPerp1mActivate=MakeRule[{G3[-y,z]DRLambdaPerp1m[-z,-a],Evaluate[G3[-y,z]B[x,-z]DpRLambdaPerp1m[-x,-a]+(G[-a,i]-PPara[-a,i])G3[-y,z]DRLambdaPerp1m[-z,-i]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaPerp2pActivate=MakeRule[{G3[-y,z]DRLambdaPerp2p[-z,-a,-b],Evaluate[G3[-y,z]B[x,-z]DpRLambdaPerp2p[-x,-a,-b]+(G[-a,i]G[-b,j]-PPara[-a,i]PPara[-b,j])G3[-y,z]DRLambdaPerp2p[-z,-i,-j]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
DpRLambdaPerp2mActivate=MakeRule[{G3[-y,z]DRLambdaPerp2m[-z,-a,-b,-c],Evaluate[G3[-y,z]B[x,-z]DpRLambdaPerp2m[-x,-a,-b,-c]+(G[-a,i]G[-b,j]G[-c,k]-PPara[-a,i]PPara[-b,j]PPara[-c,k])G3[-y,z]DRLambdaPerp2m[-z,-i,-j,-k]/.PADMActivate]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
...
(* ::Input::Initialization:: *)
(*UnknownSymb="\[Star]";
DefTensor[DpHComp[-z],M4,PrintAs\[Rule]SymbolBuild[UnknownSymb,"Derivative"->2],OrthogonalTo\[Rule]{V[z]}];
DpHCompActivate=MakeRule[{G3[-y,z]DHComp[-z],G3[-y,z]B[x,-z]DpHComp[-x]},MetricOn\[Rule]All,ContractMetrics\[Rule]True];
