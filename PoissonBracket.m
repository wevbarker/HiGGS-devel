...
If[OptionValue["Parallel"],
	...
	If[OptionValue["Surficial"],
		...
		Expr=ToNesterForm[#,"ToShell"->OptionValue["ToShell"],"Hard"->OptionValue["Hard"],"Order"->OptionValue["Order"],"GToFoliG"->OptionValue["GToFoliG"]]&/@Expr;
	...
	HiGGSPrint[{LeftOperand,RightOperand}," \[TildeTilde] ",Expr];,
	HiGGSPrint[{LeftOperand,RightOperand}," = ",Expr];
	];
	*)
