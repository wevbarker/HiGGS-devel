...
kernel_files = os.listdir("bin/node-1/stats/")
...
def make_np(filename):
    return pd.read_csv('bin/node-1/stats/'+filename).to_numpy()
...
plt.savefig('peta4.plt.png',bbox_inches = 'tight',pad_inches=0,dpi = 300)
